...
impl Apu {
    ...
    pub fn read_registers(&mut self, address: u16) -> u8 {
        match address {
            0x4000 => self.pulse_1.get_byte_0(value),
            0x4001 => self.pulse_1.get_byte_1(value),
            0x4002 => self.pulse_1.get_byte_2(value),
            0x4003 => self.pulse_1.get_byte_3(value),
            0x4004 => self.pulse_2.get_byte_0(value),
            0x4005 => self.pulse_2.get_byte_1(value),
            0x4006 => self.pulse_2.get_byte_2(value),
            0x4007 => self.pulse_2.get_byte_3(value),
            0x4008 => self.triangle.get_byte_0(value),
            0x4009 => 0, // Unused
            0x400a => self.triangle.get_byte_2(value),
            0x400b => self.triangle.get_byte_3(value),
            0x400c => self.noise.get_byte_0(value),
            0x400d => 0, // Unused
            0x400e => self.noise.get_byte_2(value),
            0x400f => self.noise.get_byte_3(value),
            0x4010 => self.dmc.get_byte_0(value),
            0x4011 => self.dmc.get_byte_1(value),
            0x4012 => self.dmc.get_byte_2(value),
            0x4013 => self.dmc.get_byte_3(value),
            0x4015 => self.get_status(value),
            0x4017 => self.get_frame_counter(value),
            _ => (),
        }
    }
